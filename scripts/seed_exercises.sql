-- Insert packages
INSERT IGNORE INTO packages (id, title, description, cover_image_id) VALUES
(1, 'مفرد و جمع', 'تعرّف على المفرد والجمع', 1);

-- Insert questions (linking to package 1)
INSERT IGNORE INTO questions (id, package_id, question_text, correct_answer, order_index) VALUES
